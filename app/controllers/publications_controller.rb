class PublicationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @publication.update(publication_params)
        format.html { redirect_to @publication, notice: 'Publication was successfully updated.', status: :see_other }
  ...
  def publication_params
    params.require(:publication).permit(:publication_id, :professor_id, :student_id, :name, :abstract, :link, :publication_date)
  end
